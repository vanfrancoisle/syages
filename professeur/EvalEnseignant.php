...
// $lesEval=$m->les_derniers_eval_du_prof(11111113);
//var_dump($lesEval);*/
	...
	<div class="melbanner">
        ...
        <div class="tabeval">
                ...
                <tr><th>Matières</th><th>Promo concernée</th><th>Date</th><th>Coefficient</th><th>Type d'évaluation</th></tr>
					...
					<?php
                       /*foreach ($lesEval as $ligne){
						...
						foreach	($ctrl as $ev){
							echo '<tr><td>'. $ev['idEval'] . '</td><td>' . $ev['idPromo'] . '</td><td>' . $ev['Date'] . '</td><td>' . $ev['Coef'] . '</td><td>' . $ev['Mode'] . '</td></tr>';
						}
                    ?>
                </table>
            </div>
            ...
            <div class="eval">
                ...
                <form action="gestion_controle.php" method="post">
				...
				<p>Matières : 
                    ...
                    <p><label>Coefficient:<input type="text" name="coeff"/></label></p>
					<button class="btn_submit" type="submit">Créer une évaluation</button>
